 ...
 * @property \backend\models\GalleryTranslate[] $galleryTranslates
...
abstract class Gallery extends \yii\db\ActiveRecord
{
    ...
    */
     ...
     * @return \yii\db\ActiveQuery
     */
    public function getGalleryTranslates()
    {
        return $this->hasMany(\backend\models\GalleryTranslate::className(), ['gallery_id' => 'id']);
    }
