...
<ul class="visitor"> 
    <li class="special" style="color:black;width: 100%;clear:both;"><span style="float:left;" class="leftspan"><?= Yii::t('app', 'Online') ?></span> <span style="float:right;" class="rightspan"><?php echo $online; ?></span></li>
    <li class="special" style="color:black;width: 100%;clear:both;"><span style="float:left;" class="leftspan"><?= Yii::t('app', 'Today') ?></span> <span style="float:right;" class="rightspan"><?php echo $day; ?></span></li>
    <li class="special" style="color:black;width: 100%;clear:both;"><span style="float:left;" class="leftspan"><?= Yii::t('app', 'Yesterday') ?></span> <span style="float:right;" class="rightspan"><?php echo $yesterday; ?></span></li>
    <li class="special" style="color:black;width: 100%;clear:both;"><span style="float:left;" class="leftspan"><?= Yii::t('app', 'Week') ?></span> <span style="float:right;" class="rightspan"><?php echo $week; ?></span></li>
    <li class="special" style="color:black;width: 100%;clear:both;"><span style="float:left;" class="leftspan"><?= Yii::t('app', 'Month') ?></span> <span style="float:right;" class="rightspan"><?php echo $month; ?></span></li>
    <li class="special" style="color:black;width: 100%;clear:both;"><span style="float:left;" class="leftspan"><?= Yii::t('app', 'Year') ?></span> <span style="float:right;" class="rightspan"><?php echo $year; ?></span></li>
    <li class="special" style="color:black;width: 100%;clear:both;"><span style="float:left;" class="leftspan"><?= Yii::t('app', 'Total') ?></span> <span style="float:right;" class="rightspan"><?php echo $all; ?></span></li>
    <li class="special" style="font-weight: bold;color:black;clear:both;"><?= Yii::t('app', 'Since')." ".date('Y') ?></li>
</ul>