                        ...
                        <div class="aa-blog-archive-area aa-blog-archive-2">
                            ...
                            ?>
                                ...
                                <!--<div class="col-lg-3 col-md-3 col-xs-12 col-sm-12 margdiv">
                                    <div style="width: 100%;box-shadow: 0 4px 4px rgba(0, 0, 0, 0.15);">
                                        <div style="text-align:center !important;float:left;font-size:18px !important;color:white;font-weight: normal;background-color:#5588D9 !important;padding:5px 5px 5px 5px; max-width:100%;width:100%;">
                                            <span><?= Yii::t("app", "ການ​ລົງ​ທະ​ບຽນ​ປະ​ຊົມ"); ?></span>
                                        </div>
                                        <div style="clear:both;"></div>
                                        <div class="sidebar-widget-new">
                                         <img src="<?=Yii::$app->urlManager->baseUrl?>/images/cm.jpg" style="height:260px;" class="img-responsive img-center"/>                                           
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-3 col-md-3 col-xs-12 col-sm-12 margdiv">
                                    <div style="width: 100%;box-shadow: 0 4px 4px rgba(0, 0, 0, 0.15);">
                                        <div style="text-align:center !important;float:left; font-size:18px !important;color:white;font-weight: normal;background-color:#5588D9 !important;padding:5px 5px 5px 5px; max-width:100%;width:100%;">
                                            <span><?= Yii::t("app", "ສີ່ງ​ຄຳ​ຕິ​ຊົມ"); ?></span>
                                        </div>
                                        <div style="clear:both;"></div>
                                        <div class="sidebar-widget-new">
                                         <img src="<?=Yii::$app->urlManager->baseUrl?>/images/cm.jpg" style="height:225px;" class="img-responsive img-center"/>                                           
                                        </div>
                                    </div>
                                </div> -->
                                ...
                                <div class="col-lg-3 col-md-3 col-xs-12 col-sm-12 margdiv">
                                    <div style="width: 100%;box-shadow: 0 4px 4px rgba(0, 0, 0, 0.15);">
                                        <div style="text-align:center !important; float:left;font-size:18px !important;color:white;font-weight: normal;background-color:#5588D9 !important;padding:5px 5px 5px 5px; max-width:100%;width:100%;">
                                            <span><?= Yii::t("app", "Visitors Statistics"); ?></span>
                                        </div>
                                        <div style="clear:both;"></div>
                                        <div class="sidebar-widget-new">
