...
class SiteController extends Controller
{
    ...
    {
        return \Yii::$app->response->sendFile(Yii::$app->basePath . '/web/images/' . Yii::$app->params['downloadFilePath'] . "/" . $file);
    }

    public function actionDownloadfile($file)
    {
        return \Yii::$app->response->sendFile(Yii::$app->basePath . '/web/images/photolibrarys/' . $file);
    }
