...
class SiteController extends Controller
{
    ...
    public function actionContents($id = "")
    {
        ...
        if ($verif == 1) {
            ...
            if (in_array($id, Yii::$app->params["idShowCol3"])) {
             ...
             {
                $_POST["submitbut"]=htmlspecialchars($_POST["submitbut"]);
             }
             ...
             {
                $_POST["search"]=preg_replace("/\xE2\x80\x8B/", "", htmlspecialchars($_POST["search"]));
             }
    ...
    public function actionSearch()
    {
        ...
        if (!isset($_POST['search'])) {
            ...
            $session['search'] = htmlspecialchars($_POST['search']);
    ...
    public function actionVisiter()
    {
        return $this->render('visiter');
    }
}
